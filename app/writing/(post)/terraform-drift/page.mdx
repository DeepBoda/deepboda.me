...
export const metadata = {
  ...
  openGraph: {
    type: "article",
    url: "https://deepboda.me/writing/terraform-drift",
    title: postBySlug("terraform-drift").title,
    description: postBySlug("terraform-drift").summary,
    images: [
      `/og?title=${encodeURIComponent(postBySlug("terraform-drift").title)}&kicker=${encodeURIComponent(postBySlug("terraform-drift").tags.join(" · "))}`,
    ],
  },
};
