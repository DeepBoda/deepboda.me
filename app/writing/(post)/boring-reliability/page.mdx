...
export const metadata = {
  ...
  openGraph: {
    type: "article",
    url: "https://deepboda.me/writing/boring-reliability",
    title: postBySlug("boring-reliability").title,
    description: postBySlug("boring-reliability").summary,
    images: [
      `/og?title=${encodeURIComponent(postBySlug("boring-reliability").title)}&kicker=${encodeURIComponent(postBySlug("boring-reliability").tags.join(" · "))}`,
    ],
  },
};
